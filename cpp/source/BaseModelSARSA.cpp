#include "BaseModelSARSA.h"

BaseModelSARSA::BaseModelSARSA(int64_t inputSize, const std::vector<int64_t>& hiddenSizes, const int64_t numClasses)
...
torch::Tensor BaseModelSARSA::forward(torch::Tensor x) {
    int i = 0;
