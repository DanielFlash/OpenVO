...
BaseModelPG::BaseModelPG(int64_t inputSize, const std::vector<int64_t>& hiddenSizes, const int64_t numClasses)
...
torch::Tensor BaseModelPG::forward(torch::Tensor x) {
    int i = 0;
