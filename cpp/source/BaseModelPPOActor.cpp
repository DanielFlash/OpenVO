...
BaseModelPPOActor::BaseModelPPOActor(int64_t inputSize, const std::vector<int64_t>& hiddenSizes, const int64_t numClasses)
...
torch::Tensor BaseModelPPOActor::forward(torch::Tensor x) {
    int i = 0;
